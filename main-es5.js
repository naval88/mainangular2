...
var AddpostComponent = /** @class */ (function () {
    function AddpostComponent(fb, regService, router, tokenService) {
        this.fb = fb;
    ...
    AddpostComponent.prototype.onSubmit = function (data) {
        ...
        this.regService.sendPostData(data).subscribe(function (response) {
            if (response.type == "success") {
                _this.router.navigate(['/']);
            }
            else {
                _this.technical_error = "There is some technical error";
            }
        }, function (error) {
            _this.technical_error = "There is some technical error";
        });
    ...
    ;
    AddpostComponent.prototype.getFileDetails = function (files) {
        var _this = this;
        if (files.length === 0)
            return;
...
/* harmony import */ var ng_starrating__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ng-starrating */ "./node_modules/ng-starrating/fesm5/ng-starrating.js");
...
var BlogComponent = /** @class */ (function () {
    ...
    BlogComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.limit = 1;
        this.blogservice.fetchAllPosts(this.limit).subscribe(function (response) {
            _this.post_data = response.data;
            _this.limit++;
        });
    };
    BlogComponent.prototype.loadMore = function () {
        var _this = this;
        this.blogservice.fetchAllPosts(this.limit).subscribe(function (response) {
            _this.post_data = response.data;
            _this.limit++;
    ...
    BlogComponent.prototype.onRate = function (event) {
        console.log(event);
    };
...
var CartComponent = /** @class */ (function () {
    ...
    CartComponent.prototype.removeItem = function (item_id) {
...
var ListProductsComponent = /** @class */ (function () {
    function ListProductsComponent(cartService) {
        this.cartService = cartService;
        this.products = _products__WEBPACK_IMPORTED_MODULE_2__["products"];
    }
    ListProductsComponent.prototype.ngOnInit = function () {
    };
    ListProductsComponent.prototype.share = function () {
        window.alert("Product has been shared");
    };
    ListProductsComponent.prototype.onNotify = function () {
        window.alert('You will be notified when the product goes on sale');
    };
    ListProductsComponent.prototype.addToCart = function (product) {
        this.cartService.addCart(product);
    };
    ListProductsComponent.ctorParameters = function () { return [
...
var ListcustomersComponent = /** @class */ (function () {
    function ListcustomersComponent(customerService, regService) {
    ...
    ListcustomersComponent.prototype.ngOnInit = function () {
        var _this = this;
        console.log("test");
        this.customerService.getUserData().subscribe(function (response) {
            _this.users = response.data;
        });
    };
    ListcustomersComponent.ctorParameters = function () { return [
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, router, regService) {
        this.fb = fb;
        this.router = router;
        this.regService = regService;
        this.submitted = false;
    ...
    LoginComponent.prototype.onSubmit = function (data) {
        ...
        this.regService.checkUserData(data).subscribe(function (response) {
            ...
            if (response.type == 'success') {
                ...
                _this.email_password_not_match = "email and password not match";
                console.log(_this.email_password_not_match);
            }
        }, function (error) {
            _this.email_password_not_match = "There is some technical issue";
        });
    };
...
var PopularpostComponent = /** @class */ (function () {
    function PopularpostComponent(blogservice) {
        this.blogservice = blogservice;
    }
    PopularpostComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.blogservice.fetchPopularPosts().subscribe(function (response) {
            _this.popular_post_data = response.data;
        });
    };
    PopularpostComponent.ctorParameters = function () { return [
        { type: _service_blog_service__WEBPACK_IMPORTED_MODULE_2__["BlogService"] }
    ]; };
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(fb, router, regService) {
        this.fb = fb;
        this.router = router;
        this.regService = regService;
        this.submitted = false;
    ...
    RegisterComponent.prototype.onSubmit = function (data) {
        ...
        this.regService.saveUserData(data).subscribe(function (response) {
            console.log(response);
            if (response.type == 'success') {
                _this.router.navigate(['/customers']);
            }
            _this.email_already_exist = "email already exsist";
            console.log(_this.email_already_exist);
        }, function (error) {
            _this.email_already_exist = "There is some technical issue";
        });
    };
...
var BlogService = /** @class */ (function () {
    ...
    BlogService.prototype.fetchAllPosts = function (data) {
        this.endpoint = "posts";
        if (data) {
    ...
    BlogService.prototype.fetchPopularPosts = function () {
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.removeItemFromCart = function (item_id) {
...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.getUserData = function () {
...
var RegisterService = /** @class */ (function () {
    ...
    RegisterService.prototype.saveUserData = function (data) {
        return this.httpClient.post('http://localhost:8081/sign-up', data);
    };
    ;
    RegisterService.prototype.checkUserData = function (data) {
        return this.httpClient.post('http://localhost:8081/sign-in', data);
    };
    ;
    RegisterService.prototype.sendPostData = function (data) {
...
var TokenService = /** @class */ (function () {
    ...
    TokenService.prototype.getUserData = function (param) {
        this.userinfo = this.token.split('.')[1];
        this.userinfos = JSON.parse(window.atob(this.userinfo));
